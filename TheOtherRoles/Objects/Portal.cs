...
public class Portal
{
    ...
    public Portal(Vector2 p)
    {
        ...
        var playerIsPortalmaker = CachedPlayer.LocalPlayer.Control == TheOtherRoles.Portalmaker.portalmaker;
    ...
    public static Sprite getFgAnimationSprite(int index)
    {
        ...
        if (portalFgAnimationSprites[index] == null)
            portalFgAnimationSprites[index] =
                UnityHelper.loadSpriteFromResources($"TheOtherRoles.Resources.PortalAnimation.portal_{index:000}.png",
                    115f);
