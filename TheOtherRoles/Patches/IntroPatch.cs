    ...
    class IntroCutsceneOnDestroyPatch
    {
        ...
        public static void Prefix(IntroCutscene __instance) {
            ...
            if (AmongUsClient.Instance.AmHost && TORMapOptions.shieldFirstKill && TORMapOptions.firstKillName != "" && !HideNSeek.isHideNSeekGM && !PropHunt.isPropHuntGM) {
                ...
                if (target != null) {
                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.Control.NetId, (byte)CustomRPC.SetFirstKill, Hazel.SendOption.Reliable, -1);
            ...
            static public void SetRoleTexts(IntroCutscene __instance) {
                ...
                if (modifierInfo != null) {
                    if (modifierInfo.roleId != RoleId.Lover)
                        ...
                        PlayerControl otherLover = CachedPlayer.LocalPlayer.Control == Lovers.lover1 ? Lovers.lover2 : Lovers.lover1;
