...
public static class CosmeticsUtils
{
        ...
        )
    {
        ...
        hat.displayOrder = 99;
        hat.ProductId = hat.BundleId = "TOUs_Hat_" + config.Name.Replace(' ', '_');
    ...
    )
    {
        ...
        hat.name = config.Name;
        hat.displayOrder = 99;
        hat.ProductId = "TOUs_Visor_" + config.Name.Replace(' ', '_');
        hat.ChipOffset = new Vector2(0f, 0.2f);
        hat.Free = true;
    ...
    )
    {
        ...
        hat.name = config.Name;
        hat.displayOrder = 99;
        hat.ProductId = hat.BundleId = "TOUs_NamePlate_" + config.Name.Replace(' ', '_');
        hat.ChipOffset = new Vector2(0f, 0.2f);
        hat.Free = true;
