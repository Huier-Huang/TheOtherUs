...
public class GameStartManagerPatch
{
    ...
    {
        var array = new Il2CppReferenceArray<Il2CppSystem.Object>([Mathf.CeilToInt(__instance.countDownTimer)]);
        ...
        public static void Postfix(GameStartManager __instance)
        {
            ...
            if (AmongUsClient.Instance.AmHost)
            {
                ...
                if (startingTimer <= 0 && __instance.startState == GameStartManager.StartingStates.Countdown)
                {
                    ...
                    copiedStartButton.GetComponent<SpriteRenderer>().sprite =
                        UnityHelper.loadSpriteFromResources("TheOtherUs.Resources.StopClean.png", 180f);
            ...
            else
            {
                if (!HandshakeHelper.playerVersions.ContainsKey(AmongUsClient.Instance.HostId) ||
                    TheOtherRolesPlugin.version.CompareTo(HandshakeHelper.playerVersions[AmongUsClient.Instance.HostId].version) != 0)
                {
