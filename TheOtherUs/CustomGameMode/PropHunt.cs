...
internal class PropHunt
{
    ...
    {
        return UnityHelper.loadSpriteFromResources($"TheOtherUs.Resources.IntroAnimation.intro_{index + 1000}.png", 150f,
            false);
    }

    public static void updateWhitelistedObjects()
    {
        var allNames = Helpers.readTextFromResources("TheOtherUs.Resources.Txt.Props.txt");
        var debug = false;
        ...
        if (poolablesBackground == null)
        {
            ...
            if (poolablesBackgroundSprite == null)
                poolablesBackgroundSprite =
                    UnityHelper.loadSpriteFromResources("TheOtherUs.Resources.poolablesBackground.jpg", 200f);
        }
    ...
    public static Sprite getDisguiseButtonSprite()
    {
        ...
        disguiseButtonSprite = UnityHelper.loadSpriteFromResources("TheOtherUs.Resources.DisguiseButton.png", 115f);
    ...
    public static Sprite getUnstuckButtonSprite()
    {
        ...
        unstuckButtonSprite = UnityHelper.loadSpriteFromResources("TheOtherUs.Resources.UnStuck.png", 115f);
    ...
    public static Sprite getRevealButtonSprite()
    {
        ...
        revealButtonSprite = UnityHelper.loadSpriteFromResources("TheOtherUs.Resources.Reveal.png", 115f);
    ...
    public static Sprite getInvisButtonSprite()
    {
        ...
        invisButtonSprite = UnityHelper.loadSpriteFromResources("TheOtherUs.Resources.InvisButton.png", 115f);
    ...
    public static Sprite getFindButtonSprite()
    {
        ...
        findButtonSprite = UnityHelper.loadSpriteFromResources("TheOtherUs.Resources.FindButton.png", 115f);
    ...
    public static Sprite getSpeedboostButtonSprite()
    {
        ...
        speedboostButtonSprite = UnityHelper.loadSpriteFromResources("TheOtherUs.Resources.SpeedboostButton.png", 115f);
