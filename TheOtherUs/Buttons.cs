...
{*/
    ...
    public static void setAllButtonsHandcuffedStatus(bool handcuffed, bool reset = false)
    {
        ...
        if (handcuffed && !deputyHandcuffedButtons.ContainsKey(CachedPlayer.LocalPlayer.PlayerId))
        {
            ...
            if (FastDestroyableSingleton<HudManager>.Instance.KillButton.isActiveAndEnabled)
                addReplacementHandcuffedButton(arsonistButton, DefButtonPositions.upperRowRight,
            ...
            if (CachedPlayer.LocalPlayer.Control.roleCanUseVents())
                addReplacementHandcuffedButton(arsonistButton, DefButtonPositions.upperRowCenter,
                    () =>
                    {
    ...
    public static void createButtonsPostfix(HudManager __instance)
    {
        ...
        engineerRepairButton = new CustomButton(
            () =>
            {
                ...
                var usedRepairWriter = AmongUsClient.Instance.StartRpcImmediately(
                    CachedPlayer.LocalPlayer.Control.NetId, (byte)CustomRPC.EngineerUsedRepair, SendOption.Reliable);
            ...
            () =>
            {
                return Engineer.engineer != null && Engineer.engineer == CachedPlayer.LocalPlayer.Control &&
                ...
                foreach (var task in CachedPlayer.LocalPlayer.Control.myTasks.GetFastEnumerator())
                    if (task.TaskType == TaskTypes.FixLights || task.TaskType == TaskTypes.RestoreOxy ||
                        ...
                        || (SubmergedCompatibility.IsSubmerged &&
                            task.TaskType == SubmergedCompatibility.RetrieveOxygenMask))
                        sabotageActive = true;
                return sabotageActive && Engineer.remainingFixes > 0 && CachedPlayer.LocalPlayer.Control.CanMove &&
                       !Engineer.usedFix;
            },
            () =>
            {
        ...
        janitorCleanButton = new CustomButton(
            ...
            () =>
            {
                return Janitor.janitor != null && Janitor.janitor == CachedPlayer.LocalPlayer.Control &&
...
/*
        ...
        sheriffKillButton = new CustomButton(
            () =>
            {
                ...
                if (murderAttemptResult == MurderAttemptResult.PerformKill)
                {
                    ...
                    var killWriter = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.Control.NetId,
            ...
            () =>
            {
                return Sheriff.sheriff != null && Sheriff.sheriff == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        deputyHandcuffButton = new CustomButton(
            ...
            {
                byte targetId = 0;
                PlayerControl target = Sheriff.sheriff == CachedPlayer.LocalPlayer.Control
            ...
            () =>
            {
                return ((Deputy.deputy != null && Deputy.deputy == CachedPlayer.LocalPlayer.Control) ||
                        (Sheriff.sheriff != null && Sheriff.sheriff == CachedPlayer.LocalPlayer.Control &&
        ...
        timeMasterShieldButton = new CustomButton(
            ...
            () =>
            {
                return TimeMaster.timeMaster != null && TimeMaster.timeMaster == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
        ...
        veterenAlertButton = new CustomButton(
            ...
            () =>
            {
                return Veteren.veteren != null && Veteren.veteren == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () => { return CachedPlayer.LocalPlayer.Control.CanMove; },
            () =>
        ...
        medicShieldButton = new CustomButton(
            ...
            () =>
            {
                return Medic.medic != null && Medic.medic == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        shifterShiftButton = new CustomButton(
            ...
            () =>
            {
                return Shifter.shifter != null && Shifter.shifter == CachedPlayer.LocalPlayer.Control &&
        ...
        disperserDisperseButton = new CustomButton(
            ...
            () => Disperser.disperser != null && Disperser.disperser == CachedPlayer.LocalPlayer.Control &&
                  !CachedPlayer.LocalPlayer.Data.IsDead,
            () =>
            {
        ...
        morphlingButton = new CustomButton(
            ...
            () =>
            {
                return Morphling.morphling != null && Morphling.morphling == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        camouflagerButton = new CustomButton(
            ...
            () =>
            {
                return Camouflager.camouflager != null && Camouflager.camouflager == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
        ...
        hackerButton = new CustomButton(
            ...
            () =>
            {
                return Hacker.hacker != null && Hacker.hacker == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () => { return true; },
            () =>
        ...
        trackerTrackPlayerButton = new CustomButton(
            ...
            () =>
            {
                return Tracker.tracker != null && Tracker.tracker == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
                ...
                return CachedPlayer.LocalPlayer.Control.CanMove && Tracker.currentTarget != null &&
                       !Tracker.usedTracker;
            },
            () =>
            {
        ...
        bodyGuardGuardButton = new CustomButton(
            ...
            () =>
            {
                return BodyGuard.bodyguard != null && BodyGuard.bodyguard == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
                ...
                return CachedPlayer.LocalPlayer.Control.CanMove && BodyGuard.currentTarget != null &&
                       !BodyGuard.usedGuard;
            },
            () =>
            {
        ...
        privateInvestigatorWatchButton = new CustomButton(
            ...
            () =>
            {
                return PrivateInvestigator.privateInvestigator != null &&
                       PrivateInvestigator.privateInvestigator == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
                ...
                return CachedPlayer.LocalPlayer.Control.CanMove && PrivateInvestigator.currentTarget != null &&
        ...
        vampireKillButton = new CustomButton(
            ...
            () =>
            {
                return Vampire.vampire != null && Vampire.vampire == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
                ...
                return Vampire.currentTarget != null && CachedPlayer.LocalPlayer.Control.CanMove &&
        ...
        jackalSidekickButton = new CustomButton(
            ...
            () =>
            {
                return Jackal.canCreateSidekick && Jackal.jackal != null &&
                       Jackal.jackal == CachedPlayer.LocalPlayer.Control && !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        jackalKillButton = new CustomButton(
            ...
            () =>
            {
                return Jackal.jackal != null && Jackal.jackal == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        swooperSwoopButton = new CustomButton(
            ...
            {
                /* Can See #1#
                return Jackal.canSwoop && Jackal.jackal != null && Jackal.jackal == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        sidekickKillButton = new CustomButton(
            ...
            () =>
            {
                return Sidekick.canKill && Sidekick.sidekick != null &&
                       Sidekick.sidekick == CachedPlayer.LocalPlayer.Control && !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        minerMineButton = new CustomButton(
            ...
            {
                /* Can See #1#
                return Miner.miner != null && Miner.miner == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
                /* Can Use #1#
                var hits = Physics2D.OverlapBoxAll(CachedPlayer.LocalPlayer.Control.transform.position, Miner.VentSize,
                    0);
        ...
        bomber2BombButton = new CustomButton(
            () =>
            {
                ...
                var bombWriter = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.Control.NetId,
            ...
            {
                /* Can See #1#
                return Bomber2.bomber2 != null && Bomber2.bomber2 == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
                /* On Click #1#
                return Bomber2.currentTarget && CachedPlayer.LocalPlayer.Control.CanMove;
            },
            () =>
            {
                /* On Meeting End #1#
        ...
        bomber2KillButton = new CustomButton(
            () =>
            {
                ...
                if (Bomber2.currentBombTarget == Bomber2.bomber2)
                {
                    ...
                    var bombWriter1 = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.Control.NetId,
                        (byte)CustomRPC.GiveBomb, SendOption.Reliable);
            ...
            {
                /* Can See #1#
                return Bomber2.bomber2 != null && Bomber2.hasBomb == CachedPlayer.LocalPlayer.Control &&
                       Bomber2.bombActive && !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
                /* Can Click #1#
                return Bomber2.currentBombTarget && CachedPlayer.LocalPlayer.Control.CanMove;
            },
            () =>
            {
                /* On Meeting End #1#
        ...
        werewolfKillButton = new CustomButton(
            ...
            () =>
            {
                return Werewolf.werewolf != null && Werewolf.werewolf == CachedPlayer.LocalPlayer.Control &&
            ...
            () =>
            {
                ...
                return Werewolf.currentTarget && CachedPlayer.LocalPlayer.Control.CanMove;
            },
            () => { werewolfKillButton.Timer = werewolfKillButton.MaxTimer; },
            __instance.KillButton.graphic.sprite,
            new Vector3(0, 1f, 0),
        ...
        eraserButton = new CustomButton(
            ...
            () =>
            {
                return Eraser.eraser != null && Eraser.eraser == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        placeJackInTheBoxButton = new CustomButton(
            ...
            () =>
            {
                return Trickster.trickster != null && Trickster.trickster == CachedPlayer.LocalPlayer.Control &&
        ...
        cleanerCleanButton = new CustomButton(
            ...
            () =>
            {
                return Cleaner.cleaner != null && Cleaner.cleaner == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        undertakerDragButton = new CustomButton(
            ...
            () =>
            {
                return Undertaker.undertaker != null && Undertaker.undertaker == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
                ...
                foreach (var collider2D in Physics2D.OverlapCircleAll(
                    ...
                    if (collider2D.tag == "DeadBody")
                    {
                        ...
                        return CachedPlayer.LocalPlayer.Control.CanMove &&
                               Vector2.Distance(CachedPlayer.LocalPlayer.Control.GetTruePosition(), deadBodyPosition) <
                               0.80f;
                    }
        ...
        warlockCurseButton = new CustomButton(
            ...
            () =>
            {
                return Warlock.warlock != null && Warlock.warlock == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        securityGuardButton = new CustomButton(
            ...
            () =>
            {
                return SecurityGuard.securityGuard != null &&
                       SecurityGuard.securityGuard == CachedPlayer.LocalPlayer.Control &&
        ...
        arsonistButton = new CustomButton(
            () =>
            {
                ...
                {
                    var winWriter = AmongUsClient.Instance.StartRpcImmediately(CachedPlayer.LocalPlayer.Control.NetId,
            ...
            () =>
            {
                return Arsonist.arsonist != null && Arsonist.arsonist == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        vultureEatButton = new CustomButton(
            ...
            () =>
            {
                return Vulture.vulture != null && Vulture.vulture == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        amnisiacRememberButton = new CustomButton(
            ...
            () =>
            {
                return Amnisiac.amnisiac != null && Amnisiac.amnisiac == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        mediumButton = new CustomButton(
            ...
            () =>
            {
                return Medium.medium != null && Medium.medium == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        pursuerButton = new CustomButton(
            ...
            () =>
            {
                return Pursuer.pursuer != null && Pursuer.pursuer == CachedPlayer.LocalPlayer.Control &&
            ...
            () =>
            {
                ...
                return Pursuer.blanksNumber > Pursuer.blanks && CachedPlayer.LocalPlayer.Control.CanMove &&
                       Pursuer.target != null;
            },
            () => { pursuerButton.Timer = pursuerButton.MaxTimer; },
        ...
        witchSpellButton = new CustomButton(
            ...
            () =>
            {
                return Witch.witch != null && Witch.witch == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
            ...
            () =>
            {
                ...
                if (attempt == MurderAttemptResult.BlankKill || attempt == MurderAttemptResult.PerformKill)
                {
                    ...
                    {
                        var multiplier = Mini.mini != null && CachedPlayer.LocalPlayer.Control == Mini.mini
        ...
        ninjaButton = new CustomButton(
                ...
                if (Ninja.ninjaMarked != null)
                {
                    ...
                    if (attempt == MurderAttemptResult.PerformKill || attempt == MurderAttemptResult.ReverseKill)
                    {
                        ...
                        var invisibleWriter = AmongUsClient.Instance.StartRpcImmediately(
                            CachedPlayer.LocalPlayer.Control.NetId, (byte)CustomRPC.SetInvisible, SendOption.Reliable);
            ...
            () =>
            {
                return Ninja.ninja != null && Ninja.ninja == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        blackmailerButton = new CustomButton(
            ...
            () =>
            {
                return Blackmailer.blackmailer != null && Blackmailer.blackmailer == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        mayorMeetingButton = new CustomButton(
            ...
            () =>
            {
                return Mayor.mayor != null && Mayor.mayor == CachedPlayer.LocalPlayer.Control &&
        ...
        cultistTurnButton = new CustomButton(
            ...
            () =>
            {
                return Cultist.needsFollower && Cultist.cultist != null &&
                       Cultist.cultist == CachedPlayer.LocalPlayer.Control && !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        trapperButton = new CustomButton(
            () =>
            {
                ...
                var writer =
                    AmongUsClient.Instance.StartRpc(CachedPlayer.LocalPlayer.Control.NetId, (byte)CustomRPC.SetTrap);
                writer.WriteBytesAndSize(buff);
                writer.EndMessage();
            ...
            () =>
            {
                return Trapper.trapper != null && Trapper.trapper == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
            () =>
            {
        ...
        bomberButton = new CustomButton(
            ...
            () =>
            {
                return Bomber.bomber != null && Bomber.bomber == CachedPlayer.LocalPlayer.Control &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
        ...
        thiefKillButton = new CustomButton(
            ...
            () =>
            {
                return Thief.thief != null && CachedPlayer.LocalPlayer.Control == Thief.thief &&
                       !CachedPlayer.LocalPlayer.Data.IsDead;
            },
        ...
        zoomOutButton = new CustomButton(
            ...
            () =>
            {
                if (CachedPlayer.LocalPlayer.Control == null || !CachedPlayer.LocalPlayer.Data.IsDead ||
            ...
            () => { return true; },
            () => { },
            UnityHelper.loadSpriteFromResources("TheOtherUs.Resources.MinusButton.png", 150f), // Invisible button!
...
/*
        ...
        {
        }, Helpers.loadSpriteFromResources("TheOtherUs.Resources.LoversChat.png", 150f), new Vector3(0.4f, 3.8f, 0f), __instance, KeyCode.KeypadMinus);
        ...
        hunterLighterButton = new CustomButton(
            ...
            DefButtonPositions.upperRowFarLeft,
            __instance,
            KeyCode.F,
            true,
